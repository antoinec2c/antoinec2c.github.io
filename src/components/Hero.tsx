          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-xs font-medium text-slate-700 dark:text-slate-300">
                ...
                <span>Toulouse INP — ENSEEIHT (N7) • Promotion 2025–2028</span>
              </div>
              ...
              <p className="text-lg sm:text-xl font-medium text-slate-700 dark:text-slate-300">
                Élève-Ingénieur Réseaux, Systèmes & Télécommunications
              </p>
            </div>
            ...
            <div className="p-4 rounded border-l-4 border-slate-900 dark:border-white bg-slate-50 dark:bg-slate-900 text-sm space-y-1">
              <div className="font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span>Recherche de stage technique d'ingénieur</span>
              </div>
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
              Actuellement à l'ENSEEIHT en <strong>spécialisation Réseaux & Télécoms</strong> complétée par l'<strong>Option Managership</strong>, après 3 années en CPGE scientifique (PCSI / PSI*). 
              Centré sur les architectures d'interconnexion (TCP/IP, routage dynamique RIP/OSPF sous Quagga), les systèmes Unix POSIX en C, le traitement du signal et le pilotage de projets agiles (Scrum).
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-600 dark:text-slate-400 pt-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Réserviste 1er RCP • Chef de troupe scout</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="rounded border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 p-4 space-y-3 text-xs">
              ...
              <div className="space-y-2 text-slate-700 dark:text-slate-300">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-500 dark:text-slate-400">Filière :</span>
                  <span className="font-semibold text-right">Réseaux & Télécoms</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500 dark:text-slate-400">Cursus préalable :</span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-right">Option Managership (Scrum)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500 dark:text-slate-400">Militaire :</span>
                  <span className="font-semibold text-right">Réserviste 1er RCP (PMS)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500 dark:text-slate-400">Associatif :</span>
                  <span className="font-semibold text-right">Chef de Troupe Scout</span>
                </div>
              </div>
            </div>
